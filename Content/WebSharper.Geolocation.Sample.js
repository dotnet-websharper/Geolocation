...
{
 "use strict";
 var WebSharper,Geolocation,Sample,Client,Operators,Obj,UI,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Var,Handler,Unchecked,WebSharper$Geolocation$Sample_Templates,TemplateHole,TemplateHoleModule,TextView,System,Guid,SC$1,EventQ,Client$1,Templates,Doc,JavaScript,Pervasives,Collections,Dictionary,EventTarget,Node,Var$1,WindowOrWorkerGlobalScope,JS,Object,HashSet,Seq,TemplateInitializer,VarStr,VarFloatUnchecked,VarBool,VarDateTime,VarFile,VarDomElement,View,Numeric,ConcreteVar,Snap,DictionaryUtil,Enumerator,T,SC$2,Docs,DocElemNode,CharacterData,Abbrev,Fresh,Blob,Elt,Element,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Attrs$1,Elt$1,Text,Attribute,Event,AttrModule,AttrProxy,AfterRender,AfterRenderQ,List,T$1,Strings,Array,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$3,HashSetUtil,SC$4,SC$5,SC$6,AppendList,DynamicAttrNode,Error,KeyNotFoundException,SC$7,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,BindVar,String,CheckedInput,CancellationTokenSource,DomNodes,Char,DateUtil,OperationCanceledException,Lazy,SC$9,Queue,LazyExtensionsProxy,LazyRecord,Runtime$1,console,Math,Date;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Geolocation=WebSharper.Geolocation=WebSharper.Geolocation||{};
 Sample=Geolocation.Sample=Geolocation.Sample||{};
 ...
 WebSharper$Geolocation$Sample_Templates=Global.WebSharper$Geolocation$Sample_Templates=Global.WebSharper$Geolocation$Sample_Templates||{};
 ...
 SC$1=Global.StartupCode$WebSharper_Geolocation_Sample$Client=Global.StartupCode$WebSharper_Geolocation_Sample$Client||{};
 ...
 {
  var _,b,t,s,_this,l,_this$1,p,i;
  _=(b=(t=(s=Client.status().get_View(),(_this=(l=Client.location().get_View(),(_this$1=new ProviderBuilder.New$1(),(_this$1.h.push(new TextView.New("location",l)),_this$1))),(_this.h.push(new TextView.New("status",s)),_this))),(t.h.push(Handler.EventQ2(t.k,"getlocation",function()
  {
   return t.i;
  },function()
  {
   Client.getLocation();
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],WebSharper$Geolocation$Sample_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Client.getLocation=function()
 {
  try
  {
   Client.status().Set("Getting location...");
   Client.geolocation().getCurrentPosition(function(position)
   {
    var latitude,longitude;
    latitude=position.coords.latitude;
    longitude=position.coords.longitude;
    Client.location().Set("Latitude: "+Global.String(latitude)+", Longitude: "+Global.String(longitude));
    return Client.status().Set("Location found!");
   },function(error)
   {
    return Client.status().Set("Error: "+Global.String(error.message));
   });
  }
  catch(m)
  {
   Client.status().Set("Geolocation is not supported in this browser.");
  }
 };
 Client.geolocation=function()
 {
  SC$1.$cctor();
  return SC$1.geolocation;
 };
 ...
 WebSharper$Geolocation$Sample_Templates.main=function(h)
 {
 ...
 SC$1.$cctor=function()
 {
  ...
  SC$1.location=Var$1.Create$1("");
  SC$1.status=Var$1.Create$1("");
  SC$1.geolocation=self.navigator.geolocation;
 };
